                  ...
                  (Il = (q[Il >> 2] + 15) & -16),
                    ...
                    (a = (function (a, Il, Jl, $l) {
                      ...
                      return (
                        ...
                        (bm = am =
                          (fm = bm = dm = Jl) >>> 0 < 0 ? (am + 1) | 0 : am),
                        (am = (em - 1140785152) | 0),
                        (((0 | (am = dm >>> 0 < 0 ? (am + 1) | 0 : am)) ==
                          (0 | bm)) &
                          (fm >>> 0 < dm >>> 0)) |
                        (bm >>> 0 < am >>> 0)
                          ? ((am = ($l << 4) | (Jl >>> 28)),
                            (Jl = (Jl << 4) | (Il >>> 28)),
                            ((134217728 == (0 | (dm = Il &= 268435455))) &
                              (1 <= a >>> 0)) |
                            (134217728 < Il >>> 0)
                              ? ((am = (am + 1073741824) | 0),
                                (a = (Jl + 1) | 0) >>> 0 < 1 &&
                      ...
                      if (
                        ...
                        for (
                          ...
                          if (
                            ...
                            (yi = k()),
                            (u[Gi >> 2] =
                              yi < x(-3600) ? x(-3600) : x(A(yi, x(3600)))),
                            !((ui = (ui + 12) | 0) >>> 0 < wi >>> 0))
                          )
                            break;
                        }
                    ...
                    if (q[(a + 644) >> 2]) {
                      if (!(((q[(a + 428) >> 2] = 0) | Fg) < 1))
                        for (
                          ...
                          (Bg = 126),
                            (Ig = (q[(a + 432) >> 2] + Dg) | 0),
                            !q[((Cg = Dg << 2) + q[(a + 424) >> 2]) >> 2] |
                              (u[(Cg + q[(a + 448) >> 2]) >> 2] == x(0)) ||
                              (Bg = 127),
                            (o[0 | Ig] = Bg),
                            (0 | Fg) != (0 | (Dg = (Dg + 1) | 0));
                      ...
                      for (
                        ;
                        !q[((Bg = Dg << 2) + q[(a + 424) >> 2]) >> 2] |
                        (u[(Bg + q[(a + 448) >> 2]) >> 2] == x(0))
                          ? ((Bg = (q[(a + 432) >> 2] + Dg) | 0),
                            (o[0 | Bg] = 254 & r[0 | Bg]))
                          : ((Bg = (q[(a + 432) >> 2] + Dg) | 0),
                            (o[0 | Bg] = 1 | r[0 | Bg])),
                        ...
                        if (
                          (Wa = (function (a, Il, Jl) {
                            var jm,
                              ...
                              zm = 0;
                            if (
                              (ca((16 + (L = jm = (L - 576) | 0)) | 0, 0, 560),
                              Fa(a, (16 + jm) | 0, (12 + jm) | 0),
                              (km = q[(12 + jm) >> 2]) >>> 0 <= Jl >>> 0)
                            ) {
                              if (
                                (($l =
                                  ((hm = ca(Il, 0, km)) + q[(16 + jm) >> 2]) |
                                  0),
