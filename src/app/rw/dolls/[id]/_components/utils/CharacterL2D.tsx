...
import SvgObject from "../../../../../../components/Base/SvgObject";
    ...
    <>
      <div className="none-gray navbar relative top-0 z-10 flex w-full flex-row items-center !bg-opacity-75">
        ...
        <div className="flex-none gap-2">
          ...
          >
            <svg
              className="svg-fill-alt h-8 w-8"
              viewBox="0 0 20 20"
      ...
      <div className="round-gray absolute bottom-5 left-1/2 z-10 flex -translate-x-1/2 justify-center gap-2 p-2">
        ...
        >
          <SvgObject className="svg-fill-alt" svgPath="rw/other/remove" />
        </button>
        <button
          className="btn-round-gray btn-anim p-1"
          onClick={() => utils.resetTransform()}
        >
          <SvgObject className="svg-fill-alt" svgPath="rw/other/zoomOut" />
        </button>
        <button
          className="btn-round-gray btn-anim p-1"
          onClick={() => utils.zoomIn()}
        >
          <SvgObject className="svg-fill-alt" svgPath="rw/other/add" />
        </button>
      </div>
    </>
  );
