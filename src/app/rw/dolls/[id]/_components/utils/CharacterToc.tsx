...
const CharacterToc: React.FC = memo(() => {
  return (
    <Toc>
      <TocItem name="Profile" href="profile">
        <svg
      ...
      <TocItem name="Affiliation" href="affiliation">
        <svg
          className="h-full w-full"
          xmlns="http://www.w3.org/2000/svg"
          height="24px"
      ...
      <TocItem name="Backstories" href="backstories">
        <svg
          className="h-full w-full"
          xmlns="http://www.w3.org/2000/svg"
          height="24px"
      ...
      <TocItem name="Equipment" href="equipment">
        <svg
          className="h-full w-full"
          xmlns="http://www.w3.org/2000/svg"
          height="24px"
      ...
      <TocItem name="Skills" href="skills">
        <svg
          className="h-full w-full"
          xmlns="http://www.w3.org/2000/svg"
          height="24px"
      ...
      <TocItem name="Courtyard" href="courtyard">
        <svg
          className="h-full w-full"
          xmlns="http://www.w3.org/2000/svg"
          height="24px"
      ...
      <TocItem name="Gallery" href="gallery">
        <svg
          className="h-full w-full"
          xmlns="http://www.w3.org/2000/svg"
          height="24px"
      ...
      <TocItem name="Voicelines" href="voicelines">
        <svg
          className="h-full w-full"
          xmlns="http://www.w3.org/2000/svg"
          height="24px"
